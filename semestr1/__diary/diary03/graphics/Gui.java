package course1.__diary.diary03.graphics;

import course1.__diary.diary03.db.DataSerializator;
import course1.__diary.diary03.db.DataStorage;
...
import course1.__diary.diary03.logic.EventManager;
import course1.__diary.diary03.voice.Controller;
import course1.__diary.diary03.voice.Recognizer;
...
public class Gui {
    ...
    private JButton addTimeEventButton;
    ...
    public Gui() {
        ...
        addTimeEventButton.addActionListener(getAddWithTimeListener());
    ...
    private ActionListener getAddListener() {
        return e -> addEvent(true);
    }

    private ActionListener getAddWithTimeListener() {
        return e -> addEvent(false);
    }
    ...
    private ActionListener getEditListener() {
        return e -> {
            ...
            try {
                EventManager.getInstance().editEvent(id, titleField.getText(), descriptionField.getText(), dateField.getText());
    ...
    private void refreshList() {
        ...
        for (String event : EventManager.getInstance().showEvents()) {
    ...
    private void addEvent(boolean isOrdinaryEvent) {
        ...
        try {
            EventManager.getInstance().addEvent(isOrdinaryEvent, title, description, date);
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        addTimeEventButton = new JButton();
        addTimeEventButton.setText("Add event with time");
        panel2.add(addTimeEventButton, BorderLayout.SOUTH);
