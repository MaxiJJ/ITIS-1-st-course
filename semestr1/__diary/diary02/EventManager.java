//package course1.__diary.diary02;
//
//import course1.__diary.diary01.utils.CsvFileReader;
//import course1.__diary.diary01.utils.CsvFileWriter;
//import course1.__diary.diary02.util.LoadData;
//import course1.__diary.diary02.util.SaveData;
//
...
//
//        if (isOrdinaryEvent) {
//            EventList.addEvent(new course1.Event(title, description, scanOrdinaryDate()));
//        } else {
//            Calendar[] dates = scanDatePeriod();
//            EventList.addEvent(new course1.Event(title, description, dates[0], dates[1]));
//        }
//        System.out.println("course1.Event successfully added!\n\n");
//    }
//
...
//        while (!isRightDates) {
//            System.out.println("Please enter the event start date in the format \"" + course1.Event.PERIOD_EVENT.toLowerCase() + "\" :");
//            start = scanDate(course1.Event.PERIOD_EVENT);
//            System.out.println("Please enter the event end date in the format \"" + course1.Event.PERIOD_EVENT.toLowerCase() + "\" :");
//            finish = scanDate(course1.Event.PERIOD_EVENT);
...
//        System.out.println("Please enter the event date in the format \"" + course1.Event.DAY_EVENT.toLowerCase() + "\" :");
//        return scanDate(course1.Event.DAY_EVENT);
//    }
//
//    // add in a specified date format
